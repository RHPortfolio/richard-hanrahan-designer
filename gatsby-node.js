...
// From here = https://stackoverflow.com/questions/66592617/gatsby-query-for-specific-post-using-slug
...
//     query ($slug: String!) {
//       allDatoCmsDesignProject(filter: {slug: {eq: "$slug"}}) {
//         edges {
//           node {
//             slug
//           }
...
//     }
//   `)
//   const templatePath = path.resolve(`./src/templates/design-post.js`)
//
//   result.data.allDatoCmsDesignProject.forEach((node) => {
//     const { slug } = node
//     createPage({
...
// }
//
// //   data.allDatoCmsDesignProject.edges.forEach(edge => {
//     const titleSlug = edge.node.slug
//     const clientSlug = edge.node.client.clientSlug
//     actions.createPage({
//       path: projects + "/" + clientSlug  + "/" + titleSlug,
//       component: require.resolve(`./src/templates/design-post.js`),
//       context: { slug: titleSlug },
//     })
//   })
// }
